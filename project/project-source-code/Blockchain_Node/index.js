var fs = require('fs');
Web3 = require('web3');
console.log("initilize the web3");
web3 = new Web3(new Web3.providers.HttpProvider("http://127.0.0.1:7545"));
console.log("initilized web3:", web3);
...
console.log("get an eth account:");

   web3.eth.getAccounts().then(function(result){
       console.log("get all eth account:", result);
     web3.eth.defaultAccount = result[0];
   }).catch( err => { console.log(err); });

console.log("got an eth account:", web3.eth.defaultAccount);

console.log("locate contract:")
...
contractInstance = new web3.eth.Contract(abi, contractAddress, {from: web3.eth.defaultAccount});
// console.log("get contract abi:", VotingContract);
// // In your nodejs console, execute contractInstance.address to get the address at which the contract is deployed and change the line below to use your deployed address
// contractInstance = VotingContract.at(contractAddress);
console.log("located contract:", contractInstance);
